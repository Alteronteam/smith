...
for i in range(100):
    ...
    data = pd.DataFrame(
        np.random.randn(2, 1), # Gera 10 linhas e 3 colunas de números aleatórios
        columns=['a']
    )
    ...
    # Espera 1 segundo antes da próxima atualização para simular o tempo real
    time.sleep(1)

st.success("rodar denovo? recarregue a página pls =)")
print(i)
